...
import static com.udayaproject.pat.CommonUtilities.QUESTIONS_URL;
...
public class QuestionsData {
    ...
    {
        c = context;
        String serverUrl = QUESTIONS_URL;
    ...
    private static void sendResult(String result) {
        SharedPreferences sharedPreferences = c.getSharedPreferences(c.getString(R.string.questions), c.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("questions_json", "");
        editor.commit();
        editor.putString("questions_json", result);
        editor.commit();
        Log.d("Q_JSON",result);
    }
